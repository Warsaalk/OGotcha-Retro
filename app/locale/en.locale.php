...
/* Themes */
$lang['theme.kokx'] = 'kokx';
$lang['theme.kokx-nolines'] = 'kokx-nolines';
$lang['theme.tsjerk'] = 'Albert Fish';
$lang['theme.virus'] = 'ViRuS';
$lang['theme.nexus'] = 'Nexus';
$lang['theme.vii'] = 'Vii';

/* Regexes */
$lang['regex.print'] = '[^[:print:]]';

//Fuel Regex
$lang['regex.fuel'] = '([0-9.]*?) Deuterium';

//Raid Regex
$lang['regex.advanced_raid'] = 'The attacker has won the battle\!';
$lang['regex.advanced_raid'] .= '\s*He captured ([0-9.]*) metal, ([0-9.]*) crystal and ([0-9.]*) deuterium\.';
$lang['regex.advanced_raid'] .= '\s*The attacker lost a total of ([0-9.]*) units\.';
$lang['regex.advanced_raid'] .= '\s*The defender lost a total of ([0-9.]*) units\.';
$lang['regex.advanced_raid'] .= '\s*At these space coordinates now float ([0-9.]*) metal and ([0-9.]*) crystal\.';
$lang['regex.simple_raid'] = '([0-9.]*) metal, ([0-9.]*) crystal and ([0-9.]*) deuterium';

//Harvest Regex
$lang['regex.harvest'] = 'Your\s*recycler\(s\)\s*\(([0-9.]*?)\)\s*have\s*a\s*total\s*cargo\s*capacity\s*of\s*([0-9.]*?).\s*';
...
$lang['regex.round'] = '(Attacker|Defender) (.*?)\s+\(([0-9]:[0-9]{1,3}:[0-9]{1,2})\)';

//Combat Round Regex
$lang['regex.round_start'] = 'Attacker';
$lang['regex.round_fleet'] = '.*?(Attacker|Defender) ([^\n\r]*?)(\s*?\(([0-9]:[0-9]{1,3}:[0-9]{1,2})\))?';
$lang['regex.round_fleet'] .= '(\s*?Weapons: ([0-9]{0,2})0% Shields: ([0-9]{0,2})0% Armour: ([0-9]{0,2})0%)?\s*';
$lang['regex.round_fleet'] .= '(Type([A-Za-z.\-\s]*)\s*' . 'Total([0-9.\s]*).*?Weapons' . '|destroyed)\s*';
$lang['regex.round_fleet'] .= '.*?(?=Attacker|Defender)';
$lang['regex.battle_end'] = 'destroyed';
$lang['regex.attacker'] = 'attacker';

//Combat ships Regex
$lang['regex.ship_sc'] = 'S.Cargo';
$lang['regex.ship_lc'] = 'L.Cargo';
$lang['regex.ship_lf'] = 'L.Fighter';
$lang['regex.ship_hf'] = 'H.Fighter';
$lang['regex.ship_xx'] = 'Cruiser';
$lang['regex.ship_bs'] = 'Battleship';
$lang['regex.ship_col'] = 'Col.Ship';
$lang['regex.ship_rec'] = 'Recy.';
$lang['regex.ship_spio'] = 'Esp.Probe';
$lang['regex.ship_bb'] = 'Bomber';
$lang['regex.ship_sol'] = 'Sol.Sat';
$lang['regex.ship_des'] = 'Dest.';
$lang['regex.ship_rip'] = 'Deathstar';
$lang['regex.ship_bc'] = 'Battlecr.';

//Combat defences Regex
$lang['regex.def_rl'] = 'R.Launcher';
$lang['regex.def_ll'] = 'L.Laser';
$lang['regex.def_hl'] = 'H.Laser';
$lang['regex.def_gauss'] = 'Gauss';
$lang['regex.def_ion'] = 'Ionc.';
$lang['regex.def_plasma'] = 'Plasma';
$lang['regex.def_ssd'] = 'S.Dome';
$lang['regex.def_lsd'] = 'L.Dome';

//Combat Result Regex
$lang['regex.won'] = 'has won the battle!';
$lang['regex.won_attacker'] = 'attacker has won the battle!';
$lang['regex.steals'] = 'He captured\s*?([0-9.]*) metal, ([0-9.]*) crystal, and ([0-9.]*) deuterium';

$lang['regex.lost_attacker'] = 'The attacker lost a total of ([0-9.]*) units.';
$lang['regex.lost_defender'] = 'The defender lost a total of ([0-9.]*) units.';
$lang['regex.debris'] = 'At these space coordinates now float ([0-9.]*) metal and ([0-9.]*) crystal.';
$lang['regex.moon_chance'] = 'The chance for a moon to be created is ([0-9]{1,2})';
$lang['regex.moon'] = 'form a moon around the planet.';