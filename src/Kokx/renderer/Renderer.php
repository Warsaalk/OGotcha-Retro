...
namespace Kokx\Renderer;
use Plinth\Response\Parser;
...
class Renderer
{
     ...
     * @param \Kokx\Model\CombatReport $report
     * @param Dictionary $dict
     */
    public function __construct(array $settings = array(), $report, $dict, $version)
    {
	
			$this->_settings = $settings;
			$this->_report = $report;
			$this->_path = __DIR__ . DIRECTORY_SEPARATOR . $settings['theme'] . '/';
	...
	public function translate() { 
			...
			return call_user_func_array(array($this->dict,'get'),func_get_args());
	...
	public function render($file)
	{
			...
			$tpl = $this->_path . 'tpl/';
			return Parser::parse($this, $file, $tpl, '.tpl.php');
     ...
     * @param \Kokx\Model\Ship $ship
     * @param \Kokx\Model\Fleet $fleet
     * @return string
     */
	public function formatShip($attacker, \Kokx\Model\Ship $ship, \Kokx\Model\Fleet $fleet = null)
    {
