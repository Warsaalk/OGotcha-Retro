...
class Raid
{
    ...
    public static function parse($source, Dictionary $dict)
    {
         ...
         * Advanced method
         */
        $advancedSource = preg_replace( '/'.$dict->get('regex.print').'/', ' ', $source);
        
        $advancedRegex  = $dict->get('regex.advanced_raid');
