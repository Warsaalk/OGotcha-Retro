...
if ($self->_report->getWinner() == \Kokx\Model\CombatReport::DRAW){
    print $self->translate("The battle ends in a draw.") . "\n";
}elseif ($self->_report->getWinner() == \Kokx\Model\CombatReport::ATTACKER){
...
if ($self->_report->getWinner() == \Kokx\Model\CombatReport::ATTACKER){ ?>
